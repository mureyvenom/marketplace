...
$getorders = "select * from completed where merchant = '$id' and status = 'pending' and payment_status = 'confirmed'";
...
<head>
<meta charset="utf-8">
<title>DemoName | Pending Orders</title>
                  ...
                  <div class="col-md-12">
                      ...
                      <div class="card">
                          ...
                          <div class="card-header">
                              ...
                              <div align="center"><h3>Pending Orders</h3></div>
