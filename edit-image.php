...
$getImage ="select * from product_image where id = '$image_id'";
                                  ...
                                  <div class="col-md-10">
                                      ...
                                      <form role="form" enctype="multipart/form-data" action="doEditImage" method="post">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <input type="file" style="min-height: 40px;" name="image" class="form-control-file form-control" id="formimage">
