...
$getdetails = mysqli_query($connect, "select * from completed where id = '$id'");
$pull = mysqli_fetch_assoc($getdetails);
$custemail = $pull['email'];
                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                      <a href=""><img width="auto" height="47" src="https://DemoName.com/admin_images/logo.png" alt="logo"></a>
                    </td>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Hi '.$firstname.' '.$lastname.',<br>Your order on DemoName has been confirmed for delivery<br><br>
          ...
          <tr>
            <td class="button">
              ...
              <![endif]--><a class="button-mobile" href="https://DemoName.com/balance.php?oid='.$enc_id.'"
              style="background-color:#b666d2 ;border-radius:5px;color:#ffffff;display:inline-block;font-family:'.'Cabin'.', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Confirm Delivery</a></div>
            </td>
          </tr>
        </table>
      </center>
...
$confirm = mysqli_query($connect, "update completed set status = 'confirmed' where id = '$id'");

if($confirm){
    mail($custemail, 'Your order has shipped!', $body, $headers);
    $message = base64_encode("Order confirmed");
