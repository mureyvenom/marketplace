...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#home2">Grow your business</a>
      </li>
<!--
...
-->
      <li class="nav-item">
        <a class="nav-link" href="#home3">Why DemoName</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#home4">Pricing</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#home5">FAQs</a>
      </li>
<!--
      <li class="nav-item">
