...
$catselect = mysqli_query($connect, "select * from categories where id = '$catid'");
$catrow = mysqli_fetch_assoc($catselect);
...
<head>
<meta charset="utf-8">
<title>DemoName | Edit Category</title>
                  ...
                  <div class="col-md-12">
                      ...
                      <div class="card">
                          ...
                          <div class="card-header">
                              ...
                              <div align="center"><h3>Edit Category</h3></div>
                          ...
                          <div class="card-body">
                              ...
                              <div class="edit-form" >
                                  ...
                                  <div class="col-md-10">
                                      ...
                                      <form role="form" enctype="multipart/form-data" action="doEditCategory.php" method="post">
                                  
                                          <div class="form-group">
                                              
                                              <label>Category Name</label>
                        
                                            <input type="text" name="name" class="form-control" required value="<?php echo $catrow['name']; ?>">

                                        </div>
                                          
                                          <input type="hidden" name="cat_id" value="<?php echo $catrow['id']; ?>">
